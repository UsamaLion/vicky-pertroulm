...
var SalesChart = (function() {
	...
	// Methods
	$.ajax({
		url: "../dashboard/fetch_ratings_data.php",
		type: "POST",
		dataType: 'json',
		success: function(responsedata)
		{
			var colors = ['#3ABAF4','#ff833b','#333333','#c3e6cb','#dc3545','#6c757d'];
				var month = [];
				//var superlikes = [];
				//var likes = [];
				for (var i in responsedata) {
				  
				  month.push(responsedata[0][i]);
				  //superlikes.push(responsedata[1][i]);
				  //likes.push(responsedata[2][i]);
				}
				...
				function init($this) {
					var salesChart = new Chart($this, {
						...
						data: {
							...
							datasets: [{
								label: 'Superlikes',
								borderColor: "rgba(78, 185, 185, 1)",
                              pointRadius: 3,
                              pointBackgroundColor: "rgba(78, 185, 185, 1)",
                              pointBorderColor: "rgba(78, 185, 185, 1)",
                              pointHoverRadius: 3,
                              pointHoverBackgroundColor: "rgba(78, 185, 185, 1)",
                              pointHoverBorderColor: "rgba(78, 185, 185, 1)",
                              pointHitRadius: 10,
                              pointBorderWidth: 2,
								data: responsedata[1]
							},{
								label: 'likes',
								borderColor: "rgba(195, 55, 223, 1)",
                              pointRadius: 3,
                              pointBackgroundColor: "rgba(195, 55, 223, 1)",
                              pointBorderColor: "rgba(195, 55, 223, 1)",
                              pointHoverRadius: 3,
                              pointHoverBackgroundColor: "rgba(195, 55, 223, 1)",
                              pointHoverBorderColor: "rgba(195, 55, 223, 1)",
                              pointHitRadius: 10,
                              pointBorderWidth: 2,
								data: responsedata[2]
							}]
